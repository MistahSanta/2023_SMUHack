...
import AssetTypePieChart from "../Charts/AssetTypePieChart"
import LastServicedChart from "../Charts/LastServicedChart";
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        ...
        <CardDataStats title="Assets that require attention" total={`${300}`}>
        ...
        <CardDataStats title="Open work orders" total={`${openWorkOrders}`}>
          <svg
            className="fill-primary dark:fill-white"
            width="22"
            height="22"
